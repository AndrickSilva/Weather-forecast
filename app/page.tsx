    ...
    <main className="flex min-h-screen  items-center justify-between">
      <div
        className={`w-full min-h-screen ${
          true ? `bg-blue-400` : `bg-yellow-100`
      ...
      >
        ...
        <p
          className={`text-6xl font-bold ${
            true ? `text-blue-800` : `text-orange-400`
          } absolute bottom-32`}
        >
        ...
        <p
          className={`text-3xl  ${
            true ? `text-blue-100` : `text-orange-900`
          } absolute bottom-20`}
        >
        ...
        <form onSubmit={handleSubmit} className="relative w-1/2">
          <input
            ...
            className={`px-6 py-2 rounded-full border ${
              true ? `border-blue-800` : `border-orange-400`
            } w-full`}
          />
          <button
            type="submit"
            className={`${
              true ? `bg-blue-800` : `bg-yellow-400`
          ...
          <div className="flex items-center justify-between w-1/2 ">
            ...
            <span
              className={`text-2xl font-bold ${
                true ? `text-blue-900` : `text-orange-900`
              }`}
            >
